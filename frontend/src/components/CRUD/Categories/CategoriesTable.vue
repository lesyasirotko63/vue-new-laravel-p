      ...
      >
        ...
        <template v-slot:activator="{ on, attrs }">
            ...
            >
              ...
              <v-list>
                <router-link class="text-decoration-none" :to="`/admin/categories/${item.id}/edit`">
                  <v-list-item>
...
export default {
  ...
  data() {
    return {
      ...
      showFilters: false,
      filters: [{label: 'Title', title: 'title'},
  ...
  computed: {
    ...mapState({
      ...
      tableData: state => state.categories.rows,
      modalOpen: state => state.categories.modalOpen,
      deleteId: state => state.categories.deleteId,
      count: state => state.categories.count,
    }),
    dataFormatter() {
  ...
  methods: {
    ...mapActions({
      getData: 'categories/getData',
      getFilteredData: 'categories/getFilteredData',
      deleteItem: 'categories/deleteItem',
    }),
    ...mapMutations({
      setDeleteId: 'categories/setDeleteId'
    }),
    delFilter(index) {
    ...
    rowClickHandler(row) {
      this.$router.push(`/admin/categories/${row.id}/edit`)
    }
  },
}
</script>
