  ...
  export default {
    ...
    methods: {
      ...
      formatData() {
        ...
        this.categories = dataFormatter.categoriesManyListFormatterEdit(
          this.data.categories,
        );

        this.moreProducts = dataFormatter.productsManyListFormatterEdit(
          this.data.moreProducts,
        );
