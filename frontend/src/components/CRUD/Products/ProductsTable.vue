<template>
  <div>
    ...
    <div class="my-4 ml-3">
      <a :href="externalLink"> API documentation for products </a>
    </div>
    ...
    >
      ...
      <template v-slot:item.categories="{ item }">
        <span
          v-for="(i, idx) in dataFormatter.categoriesManyListFormatter(
            item.categories,
          )"
      ...
      <template v-slot:item.moreProducts="{ item }">
        <span
          v-for="(i, idx) in dataFormatter.productsManyListFormatter(
            item.moreProducts,
          )"
