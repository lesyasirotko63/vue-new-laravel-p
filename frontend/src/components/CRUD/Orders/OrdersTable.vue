      ...
      >
        ...
        <template v-slot:activator="{ on, attrs }">
            ...
            >
              ...
              <v-list>
                <router-link class="text-decoration-none" :to="`/admin/orders/${item.id}/edit`">
                  <v-list-item>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      tableData: state => state.orders.rows,
      modalOpen: state => state.orders.modalOpen,
      deleteId: state => state.orders.deleteId,
      count: state => state.orders.count,
    }),
    dataFormatter() {
  ...
  methods: {
    ...mapActions({
      getData: 'orders/getData',
      getFilteredData: 'orders/getFilteredData',
      deleteItem: 'orders/deleteItem',
    }),
    ...mapMutations({
      setDeleteId: 'orders/setDeleteId'
    }),
    delFilter(index) {
    ...
    rowClickHandler(row) {
      this.$router.push(`/admin/orders/${row.id}/edit`)
    }
  },
}
</script>
