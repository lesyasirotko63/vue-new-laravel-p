      ...
      >
        ...
        <template v-slot:activator="{ on, attrs }">
            ...
            >
              ...
              <v-list>
                <router-link class="text-decoration-none" :to="`/admin/reviews/${item.id}/edit`">
                  <v-list-item>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      modalOpen: state => state.reviews.modalOpen,
      deleteId: state => state.reviews.deleteId,
  ...
  methods: {
    ...mapActions({
      ...
      getFilteredData: 'reviews/getFilteredData',
      deleteItem: 'reviews/deleteItem',
    }),
    ...mapMutations({
    ...
    rowClickHandler(row) {
      this.$router.push(`/admin/reviews/${row.id}/edit`)
    }
  },
}
</script>
