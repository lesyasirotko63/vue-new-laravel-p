<template>
  ...
  >
    <v-list>
      ...
      <v-list-item link color="primary" :to="'/admin/products'">
        <v-list-item-action class="mr-6">
          <v-icon :size="24">mdi-animation</v-icon>
        </v-list-item-action>
        <v-list-item-content>
          <v-list-item-title link> Products </v-list-item-title>
        </v-list-item-content>
      </v-list-item>

      <v-list-item link color="primary" :to="'/admin/categories'">
        <v-list-item-action class="mr-6">
          <v-icon :size="24">mdi-animation</v-icon>
        </v-list-item-action>
        <v-list-item-content>
          <v-list-item-title link> Categories </v-list-item-title>
        </v-list-item-content>
      </v-list-item>

      <v-list-item link color="primary" :to="'/admin/orders'">
        <v-list-item-action class="mr-6">
          <v-icon :size="24">mdi-animation</v-icon>
        </v-list-item-action>
        <v-list-item-content>
          <v-list-item-title link> Orders </v-list-item-title>
        </v-list-item-content>
      </v-list-item>

      <v-list-item link color="primary" :to="'/admin/reviews'">
        <v-list-item-action class="mr-6">
          <v-icon :size="24">mdi-animation</v-icon>
        </v-list-item-action>
        <v-list-item-content>
          <v-list-item-title link> Reviews </v-list-item-title>
        </v-list-item-content>
      </v-list-item>

      <v-list-item link color="primary" :to="'/admin/promo_codes'">
        <v-list-item-action class="mr-6">
          <v-icon :size="24">mdi-animation</v-icon>
        </v-list-item-action>
        <v-list-item-content>
          <v-list-item-title link> Promo_codes </v-list-item-title>
        </v-list-item-content>
      </v-list-item>
